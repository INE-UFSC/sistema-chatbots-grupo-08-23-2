...
layout = [
    ...
    [sg.Listbox(values=["happy"], size=(50, 6), key="-LIST-", enable_events=True)],
    [sg.Image('../imagens/happy.png', size=(50,50))],
    [sg.Button("Sair")]
]
...
while True:
    ...
    if event == "-LIST-":
        ...
        image_filename = f"{selected_index}.png"  # Substitua pelo nome do arquivo da imagem
